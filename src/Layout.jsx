    ...
    return (
        <>
           <div style={{
            ...
            <div style={{background:'#35569e',
                    padding:'30px',
                    color:'white',
                    }} className="footer" class='d-flex justify-content-between'>
                    <div><h5>Address- </h5>
                    Cyber Towers hitech city
                   <h5><img src={redIcon} width={15} height='20px' style={{backgroundColor:'#35569e'}}/><a href="https://goo.gl/maps/JoqCA5GmJyY3KQw49">google map</a></h5></div>
